...
export default function AuditTrail() {
  ...
  const filteredLogs = auditLogs.filter((log) => filter === 'all' || log.severity === filter);
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    <span
                      className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${severityColors[log.severity]}`}
                    >
          ...
          <div className="py-12 text-center">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M9 17v-2a3 3 0 00-3-3H5a3 3 0 00-3 3v2a3 3 0 003 3h1a3 3 0 003-3zm6 0v-2a3 3 0 00-3-3h-1a3 3 0 00-3 3v2a3 3 0 003 3h1a3 3 0 003-3zm4-4v-2a3 3 0 00-3-3h-1a3 3 0 00-3 3v2a3 3 0 003 3h1a3 3 0 003-3z"
              />
            </svg>

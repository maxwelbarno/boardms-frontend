...
export default function UserMetaCard() {
  ...
  const getImageAlt = () => {
    return `${user?.name || 'User'} profile picture`;
  };
      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800 bg-gray-200 dark:bg-gray-700 animate-pulse"></div>
            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    <Label>Phone</Label>
                    <Input type="tel" defaultValue="+09 363 398 46" placeholder="Phone number" />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <textarea
                      ...
                      defaultValue="Experienced professional with a passion for innovation and team leadership."
                    />
                  </div>
                </div>
              </div>
